...
# 2. 调用接口命令
boluo-cli material get --params '{"id":123}' --json
```
...
- Schema 命令：`boluo-cli schema material.zc-material.get`
- HTTP：`GET /app-api/boluo/open-api/zc-material/get`
